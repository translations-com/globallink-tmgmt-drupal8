...
class GlExchangeAdapter {
  ...
  /**
   * Load Glexchange library.
   */
  private function loadLibrary() {
    $module_path = $this->moduleHandler->getModule('globallink')->getPath();
    \Phar::loadPhar($module_path . '/glexchange.phar');
  }
